...
<div class="form-group">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	    	{{Form::text('start_date', null , ['class'=>'form-control datepicker'  ,'placeholder'=>'Project Start Date','required'])}}
	    </div>
	  </div>
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	    	{{Form::text('due_date', null , ['class'=>'form-control datepicker' ,'placeholder'=>'Project Due Date','required'])}}
	    </div>
	  </div>